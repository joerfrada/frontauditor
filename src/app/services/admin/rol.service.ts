...
export class RolService {
  ...
  public getRoles(): Observable<any> {
    return this.http.get<any>(this.apiGetRoles, this.api.getHttpOptions('g'))
  ...
  public createRol(data: any): Observable<any> {
    return this.http.post<any>(this.apiCreateRoles, data, this.api.getHttpOptions('g'))
    .pipe(retry(1), catchError(this.api.errorHandle));
  }

  public updateRol(data: any): Observable<any> {
    return this.http.post<any>(this.apiUpdateRoles, data, this.api.getHttpOptions('g'))
    .pipe(retry(1), catchError(this.api.errorHandle));
  }
